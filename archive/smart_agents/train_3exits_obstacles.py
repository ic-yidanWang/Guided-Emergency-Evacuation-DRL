"""
Training Smart Agents for Evacuation at 3 Exits with Obstacles
...
import os
from evacuation_rl.environments.cellspace import Cell_Space, Exit, Ob, Ob_size, delta_t, cfg_save_step
...
output_dir = output_dir + '/smart_agents_3exits_obstacles'
model_saved_path = model_saved_path + '/smart_agents_3exits_obstacles'
